...
| 🖼️ Slides     | Create and manage presentations in XML format, read presentation content, and add or remove slides                               |
...
| `lark-slides`                   | Create and manage presentations in XML format, read presentation content, and add or remove slides            |
